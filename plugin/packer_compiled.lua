...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/user/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/copilot.lua",
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/typescript.nvim",
    url = "https://github.com/jose-elias-alvarez/typescript.nvim"
  },
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
    url = "https://github.com/inkarkat/vim-ReplaceWithRegister"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-maximizer",
    url = "https://github.com/szw/vim-maximizer"
  },
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
